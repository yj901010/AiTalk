		...
		<div class="container-login100">
			<div class="wrap-login10" >
				<div class="login100-pic js-tilt" data-tilt>
					...
					<img src="https://colorlib.com/etc/lf/Login_v1/images/img-01.png" width="290px" height="250px" alt="IMG" id="logo-img">
				</div>

				<form class="login100-form validate-form" action="${cpath}/member/join" method="post">
					<br>
					<div class="wrap-input100 validate-input" data-validate = "ID is required">
						<input class="input100" id="username" name="username" type="text" placeholder="ID">
