                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">학습 후기</h1>
                                    <!-- breadcrumb Start-->
                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0" id=""> 
						  <div class="card" style="border: 0px;">
						    <div class="card-header" style="padding: 20px; padding-bottom: 0px; background: white;">
								  <div class="container">
								    <h1 style="margin-top: 8px; text-align: center; color: #D980FA;">학습 후기</h1>
								  </div>
							</div>
								...
								<!-- 페이징 -->                            
							      <c:if test="${pageMaker.criteria.keyword eq '' }">                            
							          <div >
							           ...
							           <form action="${cpath}/board/review" id="pageFrm">
							      ...
							      <c:if test="${pageMaker2.criteria.keyword ne null}">                            
							          <div >
							           ...
							           <form action="${cpath}/board/review" id="pageFrm" method="post">
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget search_widget">
                                <form action="${cpath}/board/review" method="post">
                                    <div class="form-group">
		    ...
		    $(document).ready(function () {
		        ...
		        $("button").on("click", function(){
		  			...
		  			if(oper == "register"){
		  				...
		  				location.href = "${cpath}/board/review";
		  			}else if(oper == "remove"){
		  				if (currentVo) {
