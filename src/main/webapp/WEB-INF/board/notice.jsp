                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">공지사항</h1>
                                    <!-- breadcrumb Start-->
                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0" id=""> 
						  <div class="card" style="border: 0px;">
						    <div class="card-header" style="padding: 20px; padding-bottom: 0px; background: white;">
								  <div class="container">
								    <h1 style="margin-top: 8px; text-align: center; color: #D980FA;">공지사항</h1>
								  </div>
							</div>
						    	...
						    	<div class="row">
			    					...
			    					<div style="display: flex; justify-content: space-between; align-items: center; width: 100%; height: 100%;">
				    					...
				    					<div style="text-align: right;"> <!-- 이 div를 추가하여 버튼을 오른쪽 정렬 -->
										    <button id="newPostButton" class="btn btn-primary" data-oper="create" style="visibility: hidden;">새 글 쓰기</button>
										</div> 
						    			</c:if>
								...
								<!-- 페이징 -->                            
							      <c:if test="${pageMaker.criteria.keyword eq '' }">                            
							          <div >
							           ...
							           <form action="${cpath}/board/notice" id="pageFrm">
							      ...
							      <c:if test="${pageMaker2.criteria.keyword ne null}">                            
							          <div >
							           ...
							           <form action="${cpath}/board/notice" id="pageFrm" method="post">
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget search_widget">
                                <form action="${cpath}/board/notice" method="post">
                                    <div class="form-group">
		    ...
		    $(document).ready(function () {
		        ...
		        $("button").on("click", function(){
		  			...
		  			if(oper == "register"){
		  				...
		  				location.href = "${cpath}/board/notice";
		  			}else if(oper == "remove"){
		  				if (currentVo) {
